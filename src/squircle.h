...
//! [1]
class SquircleRenderer : public QObject, public QOpenGLFunctions
{
    Q_OBJECT
public:
    SquircleRenderer(DsoSettings *settings, bool emulate);
...
public:
    ...
    SquircleRenderer *mainScope; ///< The main scope screen
